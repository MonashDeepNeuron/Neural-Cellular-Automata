...
from abstract_nca import BasicNCA
...
class BackboneNCA(BasicNCA):
    ...
    def __init__(self, channel_n, fire_rate, device, hidden_size=128, input_channels=1):
        ...
        #self.final_conv = nn.Conv2d(30, 3, kernel_size=1)  # Ensure model output is 3 channels
        #self.final_conv = nn.Conv2d(channel_n * 3, 3, kernel_size=1)    
