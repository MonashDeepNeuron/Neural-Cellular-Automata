...
export default class BufferManager {
    ...
    static setRuleBuffer(device, modelWeights) {
        ...
        const b1 = modelWeights.slice(128 * 48, 128 * 48 + 128);
        const w2 = modelWeights.slice(128 * 48 + 128, 128 * 48 + 128 + 128 * 16);
        // const w1 = modelWeights.slice(0, (128 * 48));
    ...
    static async logBufferContents(device, cellStateA, cellStateB) {
        // Log contents of cellStateA
        await cellStateA.mapAsync(GPUMapMode.READ);
        const cellStateAArray = new Float32Array(cellStateA.getMappedRange());
        console.log("Contents of cellStateA:", cellStateAArray);
        cellStateA.unmap();

        // Log contents of cellStateB
        await cellStateB.mapAsync(GPUMapMode.READ);
        const cellStateBArray = new Float32Array(cellStateB.getMappedRange());
        console.log("Contents of cellStateB:", cellStateBArray);
        cellStateB.unmap();
    }
