...
export class ComputeShaderManager {
    ...
    static workgroupSize = 16; // only 1, 2, 4, 8, 16 work. higher is smoother. // There is a limitation though to some pcs/graphics cards // TOD: set to 16 and centralise definition
