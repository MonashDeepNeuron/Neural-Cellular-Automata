  ...
  return (
    <div className="container">
      ...
      <div className="centre">
        ...
        <p>
          This is the foundational paper behind Neural Cellular Automata (NCA), which proposes a minimalistic model that can 
          produce organism-like behaviour. This model is able to grow into simple but irregular images and demonstrates 
          robustness against perturbation.
        </p>
        <p>
          The structure and techniques used in this paper are fundamental in future work, including:
          <ul>
            <li><b>Convolutional Network architecture</b> using a learnable or non-learnable 3x3 convolution.</li>
            <li><b>Residual neural network architecture</b> for better training and gradient calculation.</li>
            <li><b>Stochastic updates</b> (random cells updated per iteration) for robustness.</li>
            <li><b>Usage of hidden channels</b> for recurrent neural network-like behaviour.</li>
          </ul>
        </p>
        ...
        <h4><i>Eyvind Niklasson, Alexander Mordvintsev, Ettore Randazzo, Michael Levin</i></h4>
        <p>
          This paper advances NCA by focusing on local, small-scale features rather than generating an entire image.
          The result allows the model to generate cohesive patterns across grids of any size.
        </p>
        <p>
          Below are the results from our own re-implementation:
        </p>

        <div className="sideBySide">
          <div className="sideDiagramContainer">
            <video className="sideDiagram" loop autoPlay>
        ...
        <p>
          This paper focuses on 3D texture generation, moving NCA onto a mesh or graph. Each cell is now a node, 
          with its neighbours defined by the connections between graph edges. 
        </p>
        ...
        <p>
          ...
          <ul>
            ...
            <li><b>Adapting to different grid sizes without explicit retraining</b></li>
            <li><b>Classifying images</b></li>
            <li><b>Interpreting external signals</b></li>
            <li><b>Producing exceptionally small and efficient models</b></li>
          </ul>
        </p>
      </div>
    </div>
