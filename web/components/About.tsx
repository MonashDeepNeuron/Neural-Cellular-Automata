        ...
        <Card className="max-w-4xl mx-auto p-12 bg-card/50 backdrop-blur-sm border-primary/20">
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              We are a research project team under{" "}
              <span className="text-foreground font-semibold">Monash DeepNeuron</span>, 
              exploring the potential of Neural Cellular Automata (NCA) for various applications. 
