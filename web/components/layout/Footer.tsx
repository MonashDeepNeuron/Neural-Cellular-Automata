			...
			<div className='container mx-auto px-6 py-12'>
				<div className='grid md:grid-cols-4 gap-8'>
					...
					<div className='space-y-4'>
						<div className='flex items-center gap-2'>
							<span className='font-bold text-lg'>
								Neural<span className='text-primary'>CA</span>
							</span>
						</div>
						<p className='text-sm text-muted-foreground'>Exploring Neural Cellular Automata under Monash DeepNeuron</p>
					</div>
					...
					<div>
						...
						<ul className='space-y-2 text-sm text-muted-foreground'>
							<li>
								<Link href='/learn/research' className='hover:text-primary transition-colors'>
									Research
								</Link>
							</li>
							<li>
