		...
		<div className='max-w-4xl mx-auto px-6 py-10 text-gray-800'>
			...
			<section className='mb-8'>
				...
				<p>
					...
					smooth animations from a single image. Below are the results from our re-implementation:
				</p>
			...
			<section className='mb-8'>
				...
				<h4 className='italic text-gray-600'>John Kalkhof, Camila González & Anirban Mukhopadhyay</h4>
				<p>gecko</p>
			</section>
