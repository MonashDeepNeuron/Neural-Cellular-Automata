	...
	return (
		<div className="max-w-4xl mx-auto px-6 py-10 text-gray-800">
			...
			<section>
				...
				<p className="leading-7 text-lg mt-4">
					Continuous Cellular Automata builds on life-like CA. The key difference is that instead of using binary states (dead or alive),
					we use a continuous range of values, allowing for more nuanced behaviors.
				</p>
			</section>
		</div>
	);
