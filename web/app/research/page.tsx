		...
		<div className='max-w-4xl mx-auto px-6 py-10 text-gray-800'>
			...
			<section className='mb-8'>
				...
				<ul className='list-disc list-inside ml-4'>
					<li>
						<b>Convolutional Network architecture:</b> Learnable or non-learnable 3x3 convolution.
					</li>
					<li>
						<b>Residual neural network architecture:</b> Improves training and gradient calculation.
					</li>
					<li>
						<b>Stochastic updates:</b> Random cells updated per iteration for robustness.
					</li>
					<li>
						<b>Hidden channels:</b> Enables recurrent neural network-like behaviour.
					</li>
				</ul>
			</section>
