		...
		<div className='max-w-3xl mx-auto px-6 py-10 text-gray-800'>
			...
			<section className='mb-8'>
				...
				<div className='grid grid-cols-3 gap-4 mb-8'>
					<ProfileCard name='Afraz Gul' imageLink='/images/profile/Afraz.jpg' subtitle='Project Lead' description='Bachelor of Science and Computer Science'/>
				...
				<h2 className='text-2xl font-semibold text-purple-mdn mb-2'>And our advisors and alumni</h2>
				<p>Their help has been just as invaluable to the project!</p>
				<div className='grid grid-cols-3 gap-4'>
					<ProfileCard name='Keren Collins' imageLink='/images/profile/Keren.jpg' subtitle='Project founder and advisor' description='Bachelor of Biomedical Engineering'/>
					<ProfileCard name='Joshua Riantoputra' imageLink='/images/profile/Josh.jpg' subtitle='Deep Learning Advisor' description='Bachelor of Mathematics and Computational Science'/>
