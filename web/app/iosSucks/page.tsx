...
export default function WebGPUSetup() {
    return (
        <>
            ...
            <p className="mb-4">
                WebGPU is not yet natively supported on iOS devices like iPhone and iPad.
                However, you can enable experimental support by following these steps:
            </p>
            ...
            <ol className="list-decimal list-inside space-y-8 mb-10">
                ...
                <li>
                    ...
                    <div className="mt-2">
                        <Image src="/webGPUSetup/Step1.jpg" alt="Navigate to Experimental Features" width={150} height={100} className="rounded-md shadow" />
                    </div>
                </li>
                <li>
                    Go to <strong>Advanced</strong>.
                    <div className="mt-2">
                        <Image src="/webGPUSetup/Step2.jpg" alt="Navigate to Experimental Features" width={150} height={100} className="rounded-md shadow" />
                    </div>
                </li>
                <li>
                    Go to <strong>Experimental Features</strong>.
                    <div className="mt-2">
                        <Image src="/webGPUSetup/Step3.jpg" alt="Navigate to Experimental Features" width={150} height={100} className="rounded-md shadow" />
                    </div>
                </li>
                <li>
            ...
            <div className="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-800 p-4 rounded-md shadow mb-10">
                ...
                <p>
                    WebGPU support on iOS is experimental. Some features may be unstable or perform differently
            ...
            <ul className="list-disc list-inside space-y-2 mb-6">
                <li>Make sure your device is running <strong>iOS 17 or later</strong>.</li>
                <li>Use the <strong>Safari browser</strong> (This is only tested for Safari).</li>
            </ul>
