			...
			<main className='pt-24 pb-16'>
				<div className='container mx-auto px-6'>
					...
					<div className='max-w-4xl mx-auto mb-12 text-center'>
						...
						<h1 className='text-4xl md:text-5xl font-bold mb-4 bg-clip-text text-primary'>Setting Up WebGPU on iOS</h1>
						<p className='text-lg text-muted-foreground'>Enable experimental WebGPU support on your iPhone or iPad</p>
					</div>
								...
								<div className='flex gap-3'>
									...
									<div>
										...
										<p className='text-sm text-muted-foreground'>
											WebGPU is not yet natively supported on iOS devices like iPhone and iPad. However, you can enable experimental support
								...
								<div className='space-y-4'>
									...
									<div className='flex gap-4'>
										...
										<div className='flex-1'>
											...
											<img src='webGPUSetup/Step1.jpg' alt='Navigate to Safari settings' className='rounded-lg border shadow-sm max-w-sm' />
										</div>
									</div>
									...
									<div className='flex gap-4'>
										...
										<div className='flex-1'>
											...
											<img src='webGPUSetup/Step4.jpg' alt='Enable WebGPU' className='rounded-lg border shadow-sm max-w-sm' />
										</div>
									</div>
								...
								<div className='pt-4 border-t'>
									<div className='flex gap-3'>
										...
										<div>
											...
											<p className='text-sm text-muted-foreground'>
												WebGPU support on iOS is experimental. Some features may be unstable or perform differently compared to desktop
												browsers.
											</p>
										</div>
									</div>
							...
							<CardContent className='space-y-4'>
								<ul className='space-y-2 text-muted-foreground'>
									<li className='flex gap-2'>
										...
										<span>
											Make sure your device is running <strong className='text-foreground'>iOS 17 or later</strong>
										</span>
									</li>
									<li className='flex gap-2'>
										<span className='text-primary'>•</span>
										<span>
											Use the <strong className='text-foreground'>Safari browser</strong> (This is only tested for Safari)
										</span>
									</li>
								</ul>
